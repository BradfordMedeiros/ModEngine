static const char metal_ad_model_distortion_vs[] = R"(mtlcode
...
VS_Output _main(VS_Input Input, constant VS_ConstantBuffer& v_372)
{
    ...
    Output.ProjTangent = v_372.mCameraProj * (worldPos + worldTangent);
    Output.ProjBinormal = v_372.mCameraProj * (worldPos + worldBinormal);
