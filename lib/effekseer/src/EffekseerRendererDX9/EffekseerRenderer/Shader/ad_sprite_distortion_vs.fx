...
static const VS_Output _366 = { 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx };

cbuffer VS_ConstantBuffer : register(b0)
{
    column_major float4x4 _262_mCamera : register(c0);
    column_major float4x4 _262_mCameraProj : register(c4);
    float4 _262_mUVInversed : register(c8);
    float4 _262_flipbookParameter1 : register(c9);
    float4 _262_flipbookParameter2 : register(c10);
};
