...
{
    column_major float4x4 _39_mCamera : register(c0);
    column_major float4x4 _39_mCameraProj : register(c4);
    float4 _39_mUVInversed : register(c8);
    float4 _39_mflipbookParameter : register(c9);
};
