...
static const VS_Output _364 = { 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx };

cbuffer VS_ConstantBuffer : register(b0)
{
    column_major float4x4 _263_mCamera : register(c0);
    column_major float4x4 _263_mCameraProj : register(c4);
    float4 _263_mUVInversed : register(c8);
    float4 _263_flipbookParameter1 : register(c9);
    float4 _263_flipbookParameter2 : register(c10);
};
