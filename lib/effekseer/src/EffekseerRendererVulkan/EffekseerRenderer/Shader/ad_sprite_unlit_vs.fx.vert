...
void CalculateAndStoreAdvancedParameter(VS_Input vsinput, inout VS_Output vsoutput)
{
    ...
    vsoutput.Alpha_Dist_UV.y = _263.mUVInversed.x + (_263.mUVInversed.y * vsinput.Alpha_Dist_UV.y);
    vsoutput.Alpha_Dist_UV.w = _263.mUVInversed.x + (_263.mUVInversed.y * vsinput.Alpha_Dist_UV.w);
    ...
    vsoutput.Blend_FBNextIndex_UV.y = _263.mUVInversed.x + (_263.mUVInversed.y * vsinput.BlendUV.y);
    vsoutput.Blend_Alpha_Dist_UV = vsinput.Blend_Alpha_Dist_UV;
    vsoutput.Blend_Alpha_Dist_UV.y = _263.mUVInversed.x + (_263.mUVInversed.y * vsinput.Blend_Alpha_Dist_UV.y);
    vsoutput.Blend_Alpha_Dist_UV.w = _263.mUVInversed.x + (_263.mUVInversed.y * vsinput.Blend_Alpha_Dist_UV.w);
    float flipbookRate = 0.0;
    vec2 flipbookNextIndexUV = vec2(0.0);
    float param = flipbookRate;
    vec2 param_1 = flipbookNextIndexUV;
    vec4 param_2 = _263.flipbookParameter1;
    vec4 param_3 = _263.flipbookParameter2;
    float param_4 = vsinput.FlipbookIndex;
    vec2 param_5 = vsoutput.UV_Others.xy;
    vec2 param_6 = vec2(_263.mUVInversed.xy);
...
VS_Output _main(VS_Input Input)
{
    ...
    vec2 uv1 = Input.UV;
    uv1.y = _263.mUVInversed.x + (_263.mUVInversed.y * uv1.y);
    ...
    Output.PosVS = worldPos * _263.mCameraProj;
