...
void loadAllTextures(std::string& textureFolderPath){
  ...
  loadTextureAtlasWorld(world, "octree-atlas:main", { "./res/textures/wood.jpg", "./res/textures/water.jpg", "./res/textures/grass.jpg", "./res/textures/blacktop.jpg", "./res/textures/brickwall.jpg" }, -1);
}
