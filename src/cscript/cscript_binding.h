...
struct CustomApiBindings {
  ...
  OneShot (*playOneshot)(objid, std::optional<glm::vec3> position, std::optional<float> volume, std::optional<float> pitch, std::optional<bool> loop, std::optional<bool> center, objid ownerId);
