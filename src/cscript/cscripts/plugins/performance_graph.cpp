...
void labelGridLine(CreateTexture& createTexture, float yloc){
  mainApi -> drawText(std::to_string(static_cast<int>(round(unconvertY(yloc)))), 10,  convert(1000, yloc) + 20.f, 6, false, std::nullopt, createTexture.textureId.value(), false, std::nullopt, std::nullopt, std::nullopt, std::nullopt);
  mainApi -> drawText(std::to_string(static_cast<int>(round(unconvertY(yloc)))), 950, convert(1000, yloc) + 20.f, 6, false, std::nullopt, createTexture.textureId.value(), false, std::nullopt, std::nullopt, std::nullopt, std::nullopt);
}
...
void addPermaData(CreateTexture& createTexture){
  ...
  mainApi -> drawText("Performance - Graph of Framerate",  20, 30, 4, false, std::nullopt, createTexture.textureId.value(), false, std::nullopt, std::nullopt, std::nullopt, std::nullopt);
  mainApi -> drawText(statname, 950, 30, 4, false, std::nullopt, createTexture.textureId.value(), false, std::nullopt, std::nullopt, std::nullopt, std::nullopt);
