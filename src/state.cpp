...
std::vector<ObjectStateMapping> mapping = {
  ...
  simpleVec2Serializer("rendering", "viewport", offsetof(engineState, viewportSizeNdi), std::nullopt),
  simpleVec2Serializer("rendering", "viewportoffset", offsetof(engineState, viewportoffsetNdi), std::nullopt),
...
engineState getDefaultState(unsigned int initialScreenWidth, unsigned int initialScreenHeight){
    ...
    .viewportSizeNdi = glm::vec2(1.f, 1.f),
    .viewportoffsetNdi = glm::vec2(0, 0),
