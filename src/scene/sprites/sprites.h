...
void drawWords(GLint shaderProgram, FontFamily& fontfamily, std::string word, float left, float top, unsigned int fontSize, std::optional<float> maxWidth, glm::vec4 tint);
