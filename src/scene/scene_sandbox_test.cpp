...
void sandboxUpdateParentAbsolute(){
  ...
  updateAbsolutePosition(sandbox, objectOneId, glm::vec3(3.f, 1.f, 1.f), "test");
  updateSandbox(sandbox);
...
void sandboxUpdateParentAndChildRelative(){
  ...
  updateRelativePosition(sandbox, objectOneId, glm::vec3(3.f, 1.f, 1.f), "test");
  updateRelativePosition(sandbox, objectTwoId, glm::vec3(-4.f, -1.f, -1.f), "test");
