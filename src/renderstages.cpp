...
std::string renderStageToString(RenderStep& step){
  ...
  text = text + "colorAttachment2: " + std::to_string(step.colorAttachment2) + " (has attachment = " + (step.hasColorAttachment2 ? "true" : "false") + ")\n";
